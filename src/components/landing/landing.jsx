...
const navItems = [
  { label: "Inicio", url: "/" },
  { label: "Agrupaciones", url: "/groups" },
  { label: "Selecciones Deportivas", url: "/sports" },
];
...
const misionVision = [
  {
    title: "Misión",
    description:
      "Crear un espacio accesible para los estudiantes, que sirva para difundir información sobre agrupaciones estudiantiles y fomente la participación en actividades que desarrollen habilidades blandas.",
  },
  {
    title: "Visión",
    description:
      "Establecer una plata de conexión entre estudiantes para enriquecer la experiencia universitaria, promoviendo la interacción y el apoyo mutuo más allá del ámbito académico.",
  },
];
...
const Header = () => (
  <header className="header">
    <div className="logo-container">
      <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/5d5b8a804f35481dc17187e095b51bcc923d2f480209e51bb1e63cd10d227a6f?apiKey=807ecef27bf2490c882cc6ddc3e561c4&" alt="Logo" className="logo" />
